...
const Hero = () => {
  return (
    <div className="bg-[#15132B]  rounded-md w-[97%] p-5 flex items-center justify-between ">
      <div>
        ...
        <div className=" ml-12 xl:ml-14 my-2">
          <p className="flex ">
            Created by Instructor Day on November 31, 2022
          </p>
        </div>
        <div className="flex items-center gap-5 mt-7  ml-10 xl:ml-14">
